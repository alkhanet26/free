...
// Variables
const rootDomain = "alknet-smi.my.id"; // Ganti dengan domain utama kalian
const serviceName = "xroute"; // Ganti dengan nama workers kalian
...
const KV_PROXY_URL = "https://raw.githubusercontent.com/alkhanet26/free/main/kvProxyList.json";
const PROXY_BANK_URL = "https://raw.githubusercontent.com/alkhanet26/free/main/proxyList.txt";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>FREE VPN ACCOUNT</span>");
  ...
  async fetch(request, env, ctx) {
    try {
      ...
      if (url.pathname.startsWith("/")) {
        const page = url.pathname.match(/^(\d+)$/);
